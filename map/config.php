...
$startingLat = 47.9983853;                                          // Starting latitude
$startingLng = 7.828116;                                           // Starting longitude

/* Zoom and Cluster Settings */

$maxLatLng = 1;                                                     // Max latitude and longitude size (1 = ~110km, 0 to disable)
$maxZoomOut = 7;                                                   // Max zoom out level (11 ~= $maxLatLng = 1, 0 to disable, lower = the further you can zoom out)
...
$sessionLifetime = 1209600;                                           // Session lifetime, in seconds
$blockIframe = true;                                                // Block your map being loaded in an iframe

/* Map Title + Language */

$title = "The MAD Map to display MAD stuff";                                                 // Title to display in title bar
...
$noDiscordLogin = false;                                             // true/false - This will enable login through discord.
...
$discordBotClientSecret = "SECRET";
$discordBotRedirectUri = "https://YOURDOMAINA/discord-callback.php";


$adminUsers = array('');       // You can add multiple admins by adding them to the array.
$logfile = '../members.log';                                        // Path to log file. Make sure this works as it will be your life saver if your db crashes.
$daysMembershipPerQuantity = 1000000;                                    // How many days membership one selly quantity will give.
...
$serverWhitelist = ['Server1', 'Server2', 'Server3'];                                            // Array of server ID's. Your users will need to be in at least one of them
...
$noRarityDisplay = true;                                       // true/false
$noWeatherIcons = true;
...
$noBigKarp = true;                                                 // BUGGED: Hides ALL Magikarp && the menu setting. true/false
...
$hideQuestsItem = '[]';    // Item ids "See protos https://github.com/Furtif/POGOProtos/blob/master/src/POGOProtos/Inventory/Item/ItemId.proto"
...
$geoJSONfile = '';			    // path to geoJSON file create your own on http://geojson.io/ adjust filename
/* Location & Search Settings */

$noSearchLocation = true;                                          // true/false

$noStartMe = true;                                                 // true/false
$enableStartMe = 'false';                                           // true/false

$noStartLast = true;                                               // true/false
$enableStartLast = 'false';                                         // true/false

$noFollowMe = true;                                                // true/false
$enableFollowMe = 'false';                                          // true/false

$noSpawnArea = true;                                               // true/false
...
$notifyBounce = 'false';                                             // true/false

$notifyNotification = 'false';                                       // true/false
...
$noExGyms = true;                                                  // Do not display EX-Gyms on the map
$noParkInfo = true;                                                // Do not display Park info on the map
...
$submitMapUrl = '';
$discordSubmitLogChannelUrl = '';  // Sends gym/pokestop submit & pokestop rename directly to discord
...
$noSearchManualQuests = true;  //Wont work if noSearch = false
$noSearchNests = true;
...
$noAreas = true;
$areas = [[47.996551, 7.830088, 15, "Freiburg"]];                                                        // [[latitude,longitude,zoom,"name"],[latitude,longitude,zoom,"name"]]
...
// DATABASE CONFIG
//-----------------------------------------------------
$map = "rocketmap";                                                     // {monocle}/{rdm}
$fork = "mad";                                                  // {default/alternate/mad}/{default/beta}

$db = new Medoo([// required
    'database_type' => 'mariadb',
    'database_name' => 'rocket-db',
    'server' => 'rocket-db',
    'username' => 'rocket-db',
...
$noSubmit = false;   // Default is true
$manualdb = new Medoo([// required
    'database_type' => 'mariadb',
    'database_name' => 'pmsf',
    'server' => 'pmsf-db',
    'username' => 'pmsf',
    'password' => 'YourOtherStrongPW',
    'charset' => 'utf8mb4',
